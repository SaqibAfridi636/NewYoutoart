// src/components/pages/Casting/MyCastingCall.jsx
...
const MyCastingCall = () => {
  // keep castings in state so we can remove after delete
  ...
  const handleConfirmDelete = () => {
    // remove the selected casting from the list
    setCastings((prev) => {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 h-[calc(100vh-120px)]">
            ...
            <div className="space-y-6">
                  ...
                  {selected.description && selected.description.length > 0 ? (
                    ...
                    <>
                      <p>
                        ...
                        quibusdam nobis odit aspernatur quo tempore sunt impedit!
                      </p>
              ...
              <div>
                ...
                <div className="grid gap-4 md:grid-cols-3 text-gray-700">
                  <div>
                    <span className="font-semibold">Crew Required:</span> {selected.crewRequired}
                  </div>
                  <div>
                    <span className="font-semibold">Shoot Details:</span> {selected.shootDetails}
                  </div>
                  <div>
                    <span className="font-semibold">Budget:</span> {selected.budgetFull}
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid gap-4 md:grid-cols-3 text-gray-700">
                  <div>
                    <span className="font-semibold">Age:</span> {selected.req.age}
                  </div>
                  <div>
                    <span className="font-semibold">Height:</span> {selected.req.height}
                  </div>
                  <div>
                    <span className="font-semibold">Gender:</span> {selected.req.gender}
                  </div>
                </div>
              </div>
      ...
      {createOpen && (
        <div
          className="fixed inset-0 z-50 flex items-start md:items-center justify-center bg-black/50 p-3"
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-2 flex-shrink-0">
              ...
              <button
                onClick={() => setCreateOpen(false)}
                className="h-8 w-8 rounded-full hover:bg-gray-100 grid place-items-center text-xl"
                aria-label="Close"
              >
                ×
              </button>
            ...
            <form onSubmit={onSubmit} className="px-4 pb-4 space-y-3 overflow-y-auto">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="mt-1 w-full rounded-xl bg-gray-100 px-4 py-2 text-sm outline-none resize-none"
                  required
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  value={form.crew}
                  onChange={onChange}
                  className="mt-1 w-full appearance-none rounded-full bg-gray-100 px-4 py-2 text-sm outline-none"
                  required
                >
              ...
              <div className="flex justify-end gap-3 pt-2">
                <button
                  type="button"
                  onClick={() => setCreateOpen(false)}
                  className="px-6 py-2 rounded-full bg-red-100 text-red-600 text-sm font-medium"
                >
                  Cancel
                </button>
                <button
        ...
        >
          ...
          >
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-3 text-sm">
                    ...
                    <div>
                      ...
                      <div className="font-semibold">{selected.shoot}</div>
                    </div>
                    <div>
                      <div className="text-gray-500">Budget</div>
                      <div className="font-semibold">{selected.budget}</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="px-4 pb-4 flex justify-end gap-3">
              <button
                onClick={() => setDeleteOpen(false)}
                className="px-6 py-2 rounded-full bg-blue-100 text-blue-600 text-sm font-medium"
              >
                Keep
              </button>
              <button
